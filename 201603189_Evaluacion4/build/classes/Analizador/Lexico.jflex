...
"if" {return new Symbol(sym.Tkn_If,yyline,yychar, yytext());} 
"while" {return new Symbol(sym.Tkn_While,yyline,yychar, yytext());} 
"else" {return new Symbol(sym.Tkn_Else,yyline,yychar, yytext());} 
"{" {return new Symbol(sym.Tkn_LlaA,yyline,yychar, yytext());} 
"}" {return new Symbol(sym.Tkn_LlaC,yyline,yychar, yytext());} 
"break" {return new Symbol(sym.Tkn_break,yyline,yychar, yytext());} 
