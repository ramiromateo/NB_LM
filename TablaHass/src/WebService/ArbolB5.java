...
public class ArbolB5 {
   ...
   /* public Pagina buscar(int clave){
        return buscarRecursivo(raiz,clave);
    }*/
    
    
    
   /* private Pagina buscarRecursivo(Pagina ra,int clave){
        if(ra==null)
            return null;
        else{
            if(buscarEnNodo(ra, clave,null))
                return ra;
            else return buscarRecursivo(ra.ramas[posicionbuscar],clave);
        }
    }*/
